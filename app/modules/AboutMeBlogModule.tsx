...
const AboutMeBlogModule: React.FC<AboutMeBlogModulePropsType> = ({}) => {
  return (
    ...
    >
      <div className="order-2 col-span-1 sm:col-span-3 flex flex-col justify-center space-y-8 sm:order-1 md:col-span-2">
      ...
      <div className="order-1 sm:order-2 col-span-1 sm:col-span-2 md:col-span-3">
        <img
          src={estherWebP}
