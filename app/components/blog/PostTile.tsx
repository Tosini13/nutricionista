...
const PostTile: React.FC<PostTilePropsType> = ({ post, className }) => {
  return (
    <div
      ...
      className={twMerge(
        "group flex flex-col space-y-2 overflow-hidden rounded-xl transition-all duration-300 hover:bg-primary-light",
        className
      )}
    >
      <img
        ...
        className="aspect-video shadow-lg transition-all duration-300 group-hover:scale-105"
      />
