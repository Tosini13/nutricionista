...
const Input: React.FC<InputPropsType> = ({
  ...
  return (
    <div className={mergedContainerClassName}>
      ...
      <label
        htmlFor={id}
        className={`absolute left-0 top-0 -translate-y-[100%] pl-0 text-sm text-gray transition-all duration-200 
          ease-out peer-placeholder-shown:top-[50%] peer-placeholder-shown:-translate-y-[50%]  peer-placeholder-shown:pl-[1.1rem] peer-placeholder-shown:text-lg 
          peer-autofill:top-0 peer-focus:top-0 peer-focus:-translate-y-[100%] peer-focus:pl-0
          peer-focus:text-sm peer-focus:text-main-light`}
      >
        {placeholder}
      </label>
      {error && (
